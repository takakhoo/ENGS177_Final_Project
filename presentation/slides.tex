...
\centering
\includegraphics[height=0.62\textheight,keepaspectratio]{../figures/gamma_sensitivity_sharpe.pdf}

\smallskip
\scriptsize \textbf{However:} $\pi^\ast(\text{bull})=\pi^\ast(\text{bear})$ at \emph{every} $\gamma$. The gains are risk-tolerance shifts, not regime tilts.
\end{frame}
